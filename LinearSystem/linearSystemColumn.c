...
Assignment 3: Linear System Column Oriented
...
int main(int argc, char* argv[]) {
	...
	printf("Column oriented calculation \n");
	...
	// Reference: https://c-for-dummies.com/blog/?p=1458
        ...
        // Generating a random vector b (scaling it from 100 to 200) and printing the vector
...
// The first loop here has no data dependencies so it can be parallelized
